...
public class Neo4jToRDFConversionCLApp {
    ...
    protected File neo4jDBDirectory = null;
    ...
    protected NeoStores getNeo4jStore() {
        if (neo4jDBDumpPath != null) {
            return Neo4jStoreFactory.getNeo4jStoreFromDump(neo4jDBDumpPath, neo4jDBDirectory);
        } else {
            return Neo4jStoreFactory.getNeo4jStore(neo4jDBDirectory);
        }
    }
}
